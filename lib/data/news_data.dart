...
List<CategoryNewsModel> getCategories() {
  ...
  // 1
  categoryNewsModel.categoryName = "Bussines";
  ...
  //4
  categoryNewsModel = new CategoryNewsModel();
  categoryNewsModel.categoryName = "General";
  ...
  //5
  categoryNewsModel = new CategoryNewsModel();
  categoryNewsModel.categoryName = "Health";
  ...
  //5
  categoryNewsModel = new CategoryNewsModel();
  categoryNewsModel.categoryName = "Science";
  ...
  //6
  categoryNewsModel = new CategoryNewsModel();
  categoryNewsModel.categoryName = "Sports";
  ...
  //6
  categoryNewsModel = new CategoryNewsModel();
  categoryNewsModel.categoryName = "Technology";
